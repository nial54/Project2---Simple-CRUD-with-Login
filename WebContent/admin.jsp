...
<style>	
	...
	.button1 {background-color: #90EE90;}	
	.button2 {background-color: #AFEEEE;}
	.button3 {background-color: #D2B48C;}	
	h1 
	{
  	text-align: left;
	}
...
<nav
		...
		<div class="container">
			...
			<img src="getimage?id=<c:out value='${data.id}' />" class="center" width="125" height ="125"  border="10">
				...
				<tbody>
					...
					<c:forEach var="data" items="${listData}">
						...
						<tr>
							...
							<td><a href="viewacc?id=<c:out value='${data.id}' />">view</a>
							<td><a href="editacc?id=<c:out value='${data.id}' />">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="deleteacc?id=<c:out value='${data.id}' />">Delete</a></td>
